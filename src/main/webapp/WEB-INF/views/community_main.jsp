                ...
                <li class="cs1">
                    <a href="javascript:void(0);">
                        <span class="tit">
                            1대1 문의
                            <span class="icon-new">
                                <img src="../../resources/photo/servicecenter.png" alt="New Icon" id="service">
                            </span>
                        </span>
                        <span class="txt">
                ...
                <li class="cs2">
                    <a href="javascript:void(0);">
                        <span class="tit">
                            자주하는 질문
                            <span class="icon-new">
                                 <img src="../../resources/photo/qnaboard.png" alt="New Icon" id="qna">
                            </span>
                        </span>
                        <span class="txt">
                ...
                <li class="cs3">
                    <a href="javascript:void(0);">
                        <span class="tit">
                            후기게시판
                            <span class="icon-new">
                               <img src="../../resources/photo/reviewboard.png" alt="New Icon" id="review">
                            </span>
                        </span>
                        <span class="txt">
                ...
                <li class="cs4">
                    <a href="javascript:void(0);">
                        <span class="tit">
                            자유게시판
                            <span class="icon-new">
                                  <img src="../../resources/photo/noticeboard.png" alt="New Icon" id="notice">
                            </span>
                        </span>
                        <span class="txt">
        ...
        <div class="accordion">
            <div class="accordion-item">
                <button id="accordion-button-18" aria-expanded="false">
                    <img src="../../resources/photo/qnaQ4.png" alt="아이콘" class="accordion-button-img">
...
<script src="../../resources/community/communityjs.js"></script>
</html>
